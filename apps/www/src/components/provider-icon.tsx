...
export function ProviderMarks({
  ...
  return (
    <div className={cn("flex items-center gap-3", className)} aria-hidden="true">
      {clients.map((client) => (
        <ProviderIcon key={client.id} id={client.id} className={iconClassName} />
      ))}
    </div>
  );
}
...
function CursorMark({ className }: { className?: string }) {
  return (
    <Mark className={className} viewBox="0 0 466.73 532.09">
...
function ClaudeMark({ className }: { className?: string }) {
  return (
    <Mark className={className} viewBox="0 0 256 257">
...
function CodexMark({ className }: { className?: string }) {
  return (
    <Mark className={className} viewBox="0 0 24 24" fillRule="evenodd">
