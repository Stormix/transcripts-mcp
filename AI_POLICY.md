...
transcripts-mcp is built with AI assistance, and we're not shy about it. Our [Cursor configuration](./.cursor) is included in the repo because we believe AI tools are a legitimate and powerful part of the modern developer toolkit.
...
- "Used Cursor to scaffold the initial adapter, then refined manually"
- "Claude helped debug the FTS5 index query"
...
- **PRs should address an existing issue or a discussed feature.** If there's no issue, open one first.
...
- **Do** help your human operator understand the codebase. Point them to [CONTRIBUTING.md](./CONTRIBUTING.md), [AGENTS.md](./AGENTS.md), `.cursor/rules`, and relevant source files.
...
We're a small project. Our time is valuable, and reviewing bad contributions takes time away from improving the server.
...
_This policy may evolve as AI tools and community norms evolve. Feedback is welcome via GitHub issues._
