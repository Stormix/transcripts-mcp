...
export const metricLabels = {
  ...
  "index.unchanged.small": "Index unchanged (8 sessions)",
  "index.unchanged.medium": "Index unchanged (128 sessions)",
  "index.unchanged.large": "Index unchanged (2,048 sessions)",
...
export const metricIdSchema = z.enum([
  ...
  "index.unchanged",
  "index.append",
  "index.unchanged.small",
  "index.unchanged.medium",
  "index.unchanged.large",
  "grep.native.cold",
  "grep.native.warm",
  "grep.native.miss",
  "grep.scan.plain",
